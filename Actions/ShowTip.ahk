...
Class CTips
{
	...
	static 12 := new CTips.Tip("Activating flashing windows", "You can activate windows that are flashing in the task bar by pressing CAPSLOCK if you enable the event for this function.")
	static 13 := new CTips.Tip("Toggling between windows", "You can toggle between the current and the previous window by pressing CAPSLOCK if you enable the event for this function.")
